    ...
    return ( 
        <div className="agent">
            ...
            <div className="agent__text">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque optio cupiditate fugiat dolore magnam perspiciatis quaerat et? Officia voluptas rerum expedita sequi dolore ipsam quod corrupti assumenda ex sunt. Dignissimos veritatis dolorum amet praesentium, eligendi, debitis consequatur autem consequuntur reprehenderit dolore sunt placeat recusandae voluptas nihil accusamus voluptate, quae repellendus.</p>
                ...
                <div className="agent__navigation">
                    ...
                    <button className='second' style={{ background: "white", marginLeft: "40px" }}>
